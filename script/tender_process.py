...
class test_tender_process(unittest.TestCase):
    ...
    def tearDownClass(cls) -> None:
        # 最后做数据的自动化清理,此时的数据库访问不了，所以无法删除
        cls.session.close()
        # sql1 = "delete from mb_member_register_log where phone in ('13938768736','13033447712','13033447713','13033447714','13033447715');"
    ...
    def test05_get_loaninfo(self):
        ...
        self.assertEqual("24950", response.json().get("data").get("loan_info").get("id"))
